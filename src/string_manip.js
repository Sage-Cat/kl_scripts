...
var VARIANTS = [
  ...
  function CREATE_ARRAY_OF_PAIRS(stringData) {
    ...
    const VARIANTSData = sheet.getRange("$R$2:$U$33").getValues();
    const charValuesMap = _createCharValuesMap(VARIANTSData);
    return _createValuesArray(stringData, charValuesMap);
  }
  
  // Export public functions
  module.exports = { GET8_UNIQUE_LETTERS, GET_1_DIGIT, GET_2_DIGIT, GET_FULL_NUMBER, CREATE_ARRAY_OF_PAIRS, VARIANTS };
